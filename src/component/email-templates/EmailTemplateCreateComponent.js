...
import { createEmailTemplate } from '../../actions/action';

export default function EmailTemplateCreateComponent() {
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">Create a new email template with rich text editing and placeholder support.</p>
          </div>
          <button
            onClick={() => router.back()}
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mt-4">Template Created Successfully!</h3>
              <div className="mt-2 px-7 py-3">
                <p className="text-sm text-gray-500">
                  Your new email template has been created and saved successfully.
                </p>
              </div>
